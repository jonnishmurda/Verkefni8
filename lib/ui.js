...
export function createCartLine(product, quantity) {
  ...
  */
  ...
  const fomrElement = document.createElement('form');
  fomrElement.addEventListener('submit', deleteLineFromCart);

  const buttonElement = document.createElement('button');
  buttonElement.textContent = 'Eyða';

  fomrElement.appendChild(buttonElement);
  formTdElement.appendChild(fomrElement);
